...
sim.dir   <- "/work/users/x/i/xinxinc/super_prior/Sims_supp"

file.list <- list.files(path = sim.dir, pattern = '.rds')
save.dir  <- "Sims_supp/Results"
...
saveRDS(lst, file = file.path(save.dir, "results_all_cases.rds"))


res_avg_wts <- lst$simres.wts %>%
