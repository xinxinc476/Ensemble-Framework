...
#' function to predict survival probability at t years for treated/untreated group in a piecewise exponential
#' (PWE) model under priors other than the propensity score-integrated power prior (PSIPP).
#' Note that the PWE model does not include the treatment assignment as a covariate.
#'
#' @param t                 time
...
#' function to predict survival probability at t years for treated/untreated group in a PWE model under PSIPP.
#' Note that the PWE model does not include any covariate.
#'
#' @param t                 time
