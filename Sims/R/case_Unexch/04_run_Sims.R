## Simulation study under unexchangeable assumption
...
save.dir   <- '/work/users/x/i/xinxinc/super_prior/Sims/case_Unexch'
grid       <- readRDS(file = "Sims/R/case_Unexch/grid.rds")
seeds_list <- readRDS(file = "Sims/R/case_Unexch/seeds_list.rds")
