## Simulation study under parameter shift case
...
save.dir   <- '/work/users/x/i/xinxinc/super_prior/Sims/case_Shift'
grid       <- readRDS(file = "Sims/R/case_Shift/grid.rds")
seeds_list <- readRDS(file = "Sims/R/case_Shift/seeds_list.rds")
